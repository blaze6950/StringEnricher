...
public record MessageTextStyleStringHandler
{
    private readonly MessageTextInterpolatedStringHandler _stringHandler;

    public MessageTextStyleStringHandler(MessageTextInterpolatedStringHandler stringHandler)
    {
    ...
    public static readonly MessageTextStyleStringHandler Bold = new($"*{0}*");
    public static readonly MessageTextStyleStringHandler BoldHtml = new($"<b>{0}</b>");
    public static readonly MessageTextStyleStringHandler Italic = new($"_{0}_");
    public static readonly MessageTextStyleStringHandler Underline = new($"__{0}__");
    public static readonly MessageTextStyleStringHandler Spoiler = new($"||{0}||");
    public static readonly MessageTextStyleStringHandler Strikethrough = new($"~{0}~");
    public static readonly MessageTextStyleStringHandler InlineUrl = new($"[{0}]({1})");
}
