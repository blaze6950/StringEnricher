...
/// <summary>
/// Provides methods to apply italic styling in MarkdownV2 format.
...
public static class ItalicMarkdownV2
{
    ...
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with italic MarkdownV2 syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with italic MarkdownV2 syntax.
    /// </param>
    /// <returns>
