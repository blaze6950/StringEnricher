...
public static class CodeBlockMarkdownV2
{
    ...
    /// </returns>
    public static CodeBlockNode<IntegerNode> Apply(int integer, string? format = null, IFormatProvider? provider = null) =>
    ...
    /// </returns>
    public static CodeBlockNode<DoubleNode> Apply(double @double, string? format = null, IFormatProvider? provider = null) =>
    ...
    /// </returns>
    public static CodeBlockNode<FloatNode> Apply(float @float, string? format = null, IFormatProvider? provider = null) =>
