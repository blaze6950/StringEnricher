...
public static class CodeBlockHtml
{
    ...
    /// </returns>
    public static CodeBlockNode<PlainTextNode> Apply(string text) =>
        CodeBlockNode<PlainTextNode>.Apply(text);

    /// <summary>
    /// Applies code block style to the given boolean.
    /// </summary>
    /// <param name="boolean">
    /// The boolean to be styled as code block.
    /// </param>
    /// <returns>
    ...
    /// The character to be styled as code block.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="guid">
    /// The GUID to be styled as code block.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="integer">
    /// The integer to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="long">
    /// The long integer to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="decimal">
    /// The decimal to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="double">
    /// The double to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="float">
    /// The float to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="dateTime">
    /// The DateTime to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// The DateTimeOffset to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="dateOnly">
    /// The DateOnly to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="timeOnly">
    /// The TimeOnly to be styled as code block.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="timeSpan">
    /// The TimeSpan to be styled as code block.
    /// </param>
    /// <param name="format">
