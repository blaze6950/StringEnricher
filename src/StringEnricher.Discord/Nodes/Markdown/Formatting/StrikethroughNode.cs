...
/// <summary>
/// Represents strikethrough text in Discord markdown format.
...
{
    /// <summary>
    /// The prefix and suffix used to apply strikethrough style in Discord markdown format.
    /// </summary>
    public const string Prefix = "~~";

    /// <summary>
    /// The suffix used to apply strikethrough style in Discord markdown format.
    /// </summary>
    ...
    /// <summary>
    /// Returns the string representation of the strikethrough style in Discord markdown format.
