...
/// <summary>
/// Represents inline code text in Discord markdown format.
/// Example: "`inline code`"
/// </summary>
...
{
    /// <summary>
    /// The prefix used to denote the start of inline code in Discord markdown.
    /// </summary>
    public const string Prefix = "`";

    /// <summary>
    /// The suffix used to denote the end of inline code in Discord markdown.
    /// </summary>
    ...
    /// <summary>
    /// Returns the string representation of the inline code style in Discord markdown format.
