...
/// <summary>
/// Provides methods to apply strikethrough styling in Discord markdown format.
/// Example: "~~strikethrough text~~"
/// </summary>
public static class StrikethroughMarkdown
{
    /// <summary>
    /// Applies strikethrough style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with strikethrough Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with strikethrough Discord markdown syntax.
    /// </param>
    /// <returns>
