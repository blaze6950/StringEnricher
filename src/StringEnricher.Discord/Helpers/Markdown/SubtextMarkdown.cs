...
/// <summary>
/// Provides methods to apply single-line subtext style in Discord markdown format.
/// Example: "-# This is small subtext"
/// </summary>
public static class SubtextMarkdown
{
    /// <summary>
    /// Applies single-line subtext style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with subtext Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// <summary>
    /// Applies single-line subtext style to the given text.
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with subtext Discord markdown syntax.
    /// </param>
    /// <returns>
    ...
    /// <summary>
    /// Applies subtext style to the given TimeOnly with custom formatting.
    /// </summary>
    /// <param name="timeOnly">
    /// The TimeOnly to be styled as subtext.
    /// </param>
    /// <param name="format">
    ...
    /// <summary>
    /// Applies subtext style to the given TimeSpan with custom formatting.
    /// </summary>
    /// <param name="timeSpan">
    /// The TimeSpan to be styled as subtext.
    /// </param>
    /// <param name="format">
