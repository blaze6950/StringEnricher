...
/// <summary>
/// Provides methods to apply underline style to text in Discord markdown format.
/// Example: "__underline text__"
/// </summary>
public static class UnderlineMarkdown
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="boolean">
    /// The boolean to be styled with underline.
    /// </param>
    /// <returns>
    ...
    /// The character to be styled with underline.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="guid">
    /// The GUID to be styled with underline.
    /// </param>
    /// <returns>
    ...
    /// </returns>
    public static UnderlineNode<IntegerNode> Apply(int integer, string? format = null, IFormatProvider? provider = null) =>
    ...
    /// </summary>
    /// <param name="decimal">
    /// The decimal to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="double">
    /// The double to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </returns>
    public static UnderlineNode<DoubleNode> Apply(double @double, string? format = null, IFormatProvider? provider = null) =>
    ...
    /// </summary>
    /// <param name="float">
    /// The float to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </returns>
    public static UnderlineNode<FloatNode> Apply(float @float, string? format = null, IFormatProvider? provider = null) =>
    ...
    /// </summary>
    /// <param name="dateTime">
    /// The DateTime to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// The DateTimeOffset to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="dateOnly">
    /// The DateOnly to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="timeOnly">
    /// The TimeOnly to be styled with underline.
    /// </param>
    /// <param name="format">
    ...
    /// </summary>
    /// <param name="timeSpan">
    /// The TimeSpan to be styled with underline.
    /// </param>
    /// <param name="format">
