...
/// <summary>
/// Provides methods to apply italic styling in Discord markdown format.
/// Example: "*italic text*"
/// </summary>
public static class ItalicMarkdown
{
    /// <summary>
    /// Applies italic style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with italic Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with italic Discord markdown syntax.
    /// </param>
    /// <returns>
