...
/// <summary>
/// Provides methods to apply single-line blockquote style in Discord markdown format.
/// Example: "> blockquote text"
/// </summary>
public static class BlockquoteMarkdown
{
    /// <summary>
    /// Applies single-line blockquote style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with blockquote Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// <summary>
    /// Applies single-line blockquote style to the given text.
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with blockquote Discord markdown syntax.
    /// </param>
    /// <returns>
    ...
    /// </returns>
    public static BlockquoteNode<IntegerNode> Apply(int integer, string? format = null,
    ...
    /// </returns>
    public static BlockquoteNode<DoubleNode> Apply(double @double, string? format = null,
        IFormatProvider? provider = null) =>
    ...
    /// </returns>
    public static BlockquoteNode<TimeOnlyNode> Apply(TimeOnly timeOnly, string? format = null,
        IFormatProvider? provider = null) =>
    ...
    /// </returns>
    public static BlockquoteNode<TimeSpanNode> Apply(TimeSpan timeSpan, string? format = null,
        IFormatProvider? provider = null) =>
