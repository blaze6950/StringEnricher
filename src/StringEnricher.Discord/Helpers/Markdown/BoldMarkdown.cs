...
/// <summary>
/// Provides methods to apply bold styling in Discord markdown format.
/// Example: "**bold text**"
/// </summary>
public static class BoldMarkdown
{
    /// <summary>
    /// Applies bold style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with bold Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with bold Discord markdown syntax.
    /// </param>
    /// <returns>
