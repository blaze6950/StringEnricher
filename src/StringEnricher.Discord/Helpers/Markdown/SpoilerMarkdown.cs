...
/// <summary>
/// Provides methods to apply spoiler styling in Discord markdown format.
/// Example: "||spoiler text||"
/// </summary>
public static class SpoilerMarkdown
{
    /// <summary>
    /// Applies spoiler style to the given style.
    /// </summary>
    /// <param name="style">
    /// The inner style to be wrapped with spoiler Discord markdown syntax.
    /// </param>
    /// <typeparam name="T">
    ...
    /// </summary>
    /// <param name="text">
    /// The text to be wrapped with spoiler Discord markdown syntax.
    /// </param>
    /// <returns>
