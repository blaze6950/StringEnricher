...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            {
                private const string Name = $"{Shared.Name}.{nameof(DoubleNode)}";
                ...
                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="DoubleNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="DoubleNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="DoubleNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="DoubleNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="DoubleNode"/>.
                /// Buffers larger than this will be allocated on the heap.
