...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            public static class UShortNode
            {
                private const string Name = $"{Shared.Name}.{nameof(UShortNode)}";
                ...
                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="UShortNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="UShortNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="UShortNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="UShortNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="UShortNode"/>.
                /// Buffers larger than this will be allocated on the heap.
