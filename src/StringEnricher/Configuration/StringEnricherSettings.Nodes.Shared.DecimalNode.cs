...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        ...
        {
            /// <summary>
            /// Configuration settings for <see cref="DecimalNode"/>.
            /// </summary>
            public static class DecimalNode
            {
                private const string Name = $"{Shared.Name}.{nameof(DecimalNode)}";
                ...
                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="DecimalNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="DecimalNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="DecimalNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="DecimalNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="DecimalNode"/>.
                /// Buffers larger than this will be allocated on the heap.
