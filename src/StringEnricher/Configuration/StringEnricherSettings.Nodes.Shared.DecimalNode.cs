...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            private static NodeSettings GetDefaultDecimalNodeSettings() => new(
                name: $"{Name}.{nameof(DecimalNode)}",
            ...
            /// </summary>
            public static NodeSettings DecimalNode = GetDefaultDecimalNodeSettings();

            /// <summary>
            /// Resets the <see cref="DecimalNode"/> settings to their default values.
            /// </summary>
            public static void ResetDecimalNodeSettings() => DecimalNode = GetDefaultDecimalNodeSettings();
        }
    }
}