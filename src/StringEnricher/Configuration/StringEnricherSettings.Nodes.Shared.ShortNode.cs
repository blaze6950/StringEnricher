...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        ...
        {
            /// <summary>
            /// Configuration settings for <see cref="ShortNode"/>.
            /// </summary>
            public static class ShortNode
            {
                private const string Name = $"{Shared.Name}.{nameof(ShortNode)}";

                #region BufferSizes

                private static BufferSizes _bufferSizes = new(Name, 8, 64);

                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="ShortNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="ShortNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="ShortNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="ShortNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="ShortNode"/>.
                /// Buffers larger than this will be allocated on the heap.
