...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            private static NodeSettings GetDefaultShortNodeSettings() => new(
                name: $"{Name}.{nameof(ShortNode)}",
            ...
            /// </summary>
            public static NodeSettings ShortNode = GetDefaultShortNodeSettings();

            /// <summary>
            /// Resets the <see cref="ShortNode"/> settings to their default values.
            /// </summary>
            public static void ResetShortNodeSettings() => ShortNode = GetDefaultShortNodeSettings();
        }
    }
}