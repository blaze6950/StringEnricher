...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            private static NodeSettings GetDefaultLongNodeSettings() => new(
                name: $"{Name}.{nameof(LongNode)}",
            ...
            /// </summary>
            public static NodeSettings LongNode = GetDefaultLongNodeSettings();

            /// <summary>
            /// Resets the <see cref="LongNode"/> settings to their default values.
            /// </summary>
            public static void ResetLongNodeSettings() => LongNode = GetDefaultLongNodeSettings();
        }
    }
}