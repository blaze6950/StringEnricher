...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        ...
        {
            /// <summary>
            /// Configuration settings for <see cref="LongNode"/>.
            /// </summary>
            public static class LongNode
            {
                private const string Name = $"{Shared.Name}.{nameof(LongNode)}";
                ...
                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="LongNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="LongNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="LongNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="LongNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="LongNode"/>.
                /// Buffers larger than this will be allocated on the heap.
