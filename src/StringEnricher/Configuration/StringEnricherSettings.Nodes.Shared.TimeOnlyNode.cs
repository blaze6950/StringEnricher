...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            private static NodeSettings GetDefaultTimeOnlyNodeSettings() => new(
                name: $"{Name}.{nameof(TimeOnlyNode)}",
            ...
            /// </summary>
            public static NodeSettings TimeOnlyNode = GetDefaultTimeOnlyNodeSettings();

            /// <summary>
            /// Resets the <see cref="TimeOnlyNode"/> settings to their default values.
            /// </summary>
            public static void ResetTimeOnlyNodeSettings() => TimeOnlyNode = GetDefaultTimeOnlyNodeSettings();
        }
    }
}