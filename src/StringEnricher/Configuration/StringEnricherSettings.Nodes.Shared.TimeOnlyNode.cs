...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        ...
        {
            /// <summary>
            /// Configuration settings for <see cref="TimeOnlyNode"/>.
            /// </summary>
            public static class TimeOnlyNode
            {
                private const string Name = $"{Shared.Name}.{nameof(TimeOnlyNode)}";
                ...
                /// <summary>
                /// The multiplier to use when resizing the buffer for formatting a <see cref="TimeOnlyNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="TimeOnlyNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="TimeOnlyNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="TimeOnlyNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="TimeOnlyNode"/>.
                /// Buffers larger than this will be allocated on the heap.
