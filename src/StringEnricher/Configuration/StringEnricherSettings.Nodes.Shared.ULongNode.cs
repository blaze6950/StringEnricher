...
public static partial class StringEnricherSettings
{
    public static partial class Nodes
    {
        public static partial class Shared
        {
            ...
            /// </summary>
            public static class ULongNode
            {
                private const string Name = $"{Shared.Name}.{nameof(ULongNode)}";
                ...
                /// <summary>
                /// The growth factor to use when increasing buffer sizes for formatting a <see cref="ULongNode"/>.
                ...
                /// <summary>
                /// The initial buffer length to use when formatting a <see cref="ULongNode"/>.
                ...
                /// <summary>
                /// The maximum buffer length to use when formatting a <see cref="ULongNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be allocated on the stack when formatting a <see cref="ULongNode"/>.
                ...
                /// <summary>
                /// The maximum length of a buffer that can be rented from the array pool when formatting a <see cref="ULongNode"/>.
                /// Buffers larger than this will be allocated on the heap.
