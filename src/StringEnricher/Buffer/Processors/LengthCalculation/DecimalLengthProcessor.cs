...
/// <summary>
/// A buffer processor that formats a decimal value into a character buffer and returns the length of the formatted string.
/// It is needed to get the length of the formatted decimal with configurable allocation.
/// </summary>
public readonly struct DecimalLengthProcessor : IBufferProcessor<FormattingState<decimal>, int>
{
    /// <summary>
    /// Processes the provided character buffer using the given state and returns the length of the formatted decimal.
    /// </summary>
    /// <param name="buffer">
    /// The character buffer to be used in processing.
    /// </param>
    /// <param name="state">
    /// The state containing the decimal value, format string, and format provider to be used in processing.
    /// </param>
    /// <returns>
