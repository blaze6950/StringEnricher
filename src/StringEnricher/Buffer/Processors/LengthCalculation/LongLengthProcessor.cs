...
/// <summary>
/// A processor that calculates the length of a formatted <see cref="long"/> value.
/// </summary>
public readonly struct LongLengthProcessor : IBufferProcessor<FormattingState<long>, int>
{
    /// <summary>
    /// Processes the specified formatting state and returns the length of the formatted <see cref="long"/> value.
    /// </summary>
    /// <param name="buffer">
    /// The buffer to write the formatted value into.
    /// </param>
    /// <param name="state">
    /// The formatting state containing the <see cref="long"/> value and formatting options.
    /// </param>
    /// <returns>
    ...
    public BufferAllocationResult<int> Process(Span<char> buffer, in FormattingState<long> state)
