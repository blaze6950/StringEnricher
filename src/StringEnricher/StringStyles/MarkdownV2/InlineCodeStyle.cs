...
public static class InlineCodeMarkdownV2
{
    ...
    /// </param>
    /// <returns>
    /// An instance of <see cref="InlineCodeStyle{PlainTextStyle}"/> containing the provided text styled as inline code.
    /// </returns>
    ...
    /// </typeparam>
    /// <returns>
    /// An instance of <see cref="InlineCodeStyle{T}"/> containing the provided style wrapped with inline code syntax.
    /// </returns>
    ...
    where TInner : IStyle
{
    ...
    /// </param>
    /// <returns>
    /// A new instance of <see cref="InlineCodeStyle{TInner}"/> containing the provided inner style.
    /// </returns>
