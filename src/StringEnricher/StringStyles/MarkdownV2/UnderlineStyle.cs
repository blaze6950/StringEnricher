...
public static class UnderlineMarkdownV2
{
    ...
    /// </param>
    /// <returns>
    /// A new instance of <see cref="UnderlineStyle{PlainTextStyle}"/> that wraps the provided text.
    /// </returns>
    ...
    /// </typeparam>
    /// <returns>
    /// A new instance of <see cref="UnderlineStyle{T}"/> that wraps the provided style.
    /// </returns>
    ...
    where TInner : IStyle
{
    ...
    /// </param>
    /// <returns>
    /// A new instance of <see cref="UnderlineStyle{TInner}"/> that wraps the provided inner style.
    /// </returns>
