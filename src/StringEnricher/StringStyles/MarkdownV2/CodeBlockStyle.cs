...
public static class CodeBlockMarkdownV2
{
    ...
    /// </param>
    /// <returns>
    /// A new instance of <see cref="CodeBlockStyle{PlainTextStyle}"/> wrapping the provided plain text.
    /// </returns>
    ...
    /// </typeparam>
    /// <returns>
    /// A new instance of <see cref="CodeBlockStyle{T}"/> wrapping the provided style.
    /// </returns>
    ...
    where TInner : IStyle
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CodeBlockStyle{TInner}"/> struct.
    /// </summary>
