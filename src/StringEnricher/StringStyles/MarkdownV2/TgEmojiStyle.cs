...
{
    /// <summary>
    /// Creates a new instance of the <see cref="TgEmojiStyle{PlainTextStyle}"/> struct.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// The created instance of the <see cref="TgEmojiStyle{PlainTextStyle}"/> struct.
    /// </returns>
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="TgEmojiStyle{T}"/> struct.
    /// </summary>
    /// <param name="defaultEmoji">
    /// The default emoji to display if the custom emoji is not available.
    /// </param>
    ...
    /// </typeparam>
    /// <returns>
    /// The created instance of the <see cref="TgEmojiStyle{T}"/> struct.
    /// </returns>
    ...
    where TInner : IStyle
{
    ...
    /// </param>
    /// <returns>
    /// The created instance of the <see cref="TgEmojiStyle{TInner}"/> struct.
    /// </returns>
    public static TgEmojiStyle<TInner> Apply(TInner defaultEmoji, TInner customEmojiId) =>
