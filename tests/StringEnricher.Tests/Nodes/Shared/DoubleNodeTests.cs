...
public class DoubleNodeTests
{
    ...
    public void TryGetChar_OutOfRightRangeIndexWhenTotalLengthWasCalculated_ReturnsFalseAndNullChar()
    {
        ...
        Assert.False(result);
        Assert.Equal('\0', ch);
        Assert.Equal(1, DebugCounters.DoubleNode_TryGetChar_CachedTotalLengthEvaluation);
    }
    ...
    public void ToString_WithFormatParameter_OverridesNodeFormat()
    {
        // Arrange
        const double value = TestDouble;
        var node = new DoubleNode(value, "F2", CultureInfo.InvariantCulture);
    ...
    public void ToString_WithProviderParameter_OverridesNodeProvider()
    {
        ...
        var node = new DoubleNode(value, "N2", nodeProvider);
    ...
    public void ToString_WithNullFormat_UsesNodeFormat()
    {
        ...
        var node = new DoubleNode(value, nodeFormat, CultureInfo.InvariantCulture);
    ...
    {
        // Arrange
        var node = new DoubleNode(TestDouble, "F2", CultureInfo.InvariantCulture);
