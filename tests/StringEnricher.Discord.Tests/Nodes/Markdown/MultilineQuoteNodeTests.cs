...
public class MultilineQuoteNodeTests
{
    ...
    public void TotalLength_ReturnsCorrectLength()
    {
        ...
        var node = MultilineQuoteMarkdown.Apply(innerText);
    ...
    public void ToString_WithFormatAndProvider_ReturnsCorrectString()
    {
        // Arrange
        const int value = 123;
        var node = MultilineQuoteMarkdown.Apply(value);
    ...
    public void TryFormat_WithExactlyPrefixSpace_ReturnsFalse()
    {
        ...
        // Assert
        Assert.False(success);
        Assert.Equal(4, charsWritten); // Prefix was written before failure
    }
    ...
    public void TryFormat_WithPrefixPlusPartialInnerSpace_ReturnsFalse()
    {
        // Arrange
        var node = MultilineQuoteMarkdown.Apply("test");
        Span<char> destination = stackalloc char[6]; // Space for prefix ">>> " + 2 chars
    ...
    {
        // Arrange
        var node = MultilineQuoteMarkdown.Apply("text");
