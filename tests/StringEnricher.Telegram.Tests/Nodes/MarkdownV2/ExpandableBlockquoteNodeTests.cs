...
public class ExpandableBlockquoteNodeTests
{
    ...
    public void TryFormat_WithSufficientSpace_FormatsCorrectly()
    {
        ...
        var node = ExpandableBlockquoteMarkdownV2.Apply(innerText);
    ...
    {
        // Arrange
        var node = ExpandableBlockquoteMarkdownV2.Apply("test");
    ...
    {
        // Arrange
        var node = ExpandableBlockquoteMarkdownV2.Apply("text");
    ...
    public void ToString_WithFormatAndProvider_ReturnsCorrectString()
    {
        // Arrange
        const int value = 123;
        var node = ExpandableBlockquoteMarkdownV2.Apply(value);
