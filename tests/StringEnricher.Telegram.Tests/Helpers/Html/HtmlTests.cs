namespace StringEnricher.Telegram.Tests.Helpers.Html;
...
public class HtmlTests
{
    ...
    public void Test_NothingToEscape()
    {
        ...
        // Act
        var result = StringEnricher.Telegram.Helpers.Html.Html.Escape("string to escape");
    ...
    public void Test_Escape_AllEscapableCharacters()
    {
        ...
        // Act
        var result = StringEnricher.Telegram.Helpers.Html.Html.Escape(input);
