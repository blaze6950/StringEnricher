namespace StringEnricher.Telegram.Tests.Helpers.MarkdownV2;
...
public class MarkdownV2Tests
{
    ...
    public void Test_NothingToEscape()
    {
        ...
        // Act
        var styledBold = StringEnricher.Telegram.Helpers.MarkdownV2.MarkdownV2.Escape("string to escape");
    ...
    public void Test_Escape_AllEscapableCharacters()
    {
        ...
        // Act
        var result = StringEnricher.Telegram.Helpers.MarkdownV2.MarkdownV2.Escape(input);
